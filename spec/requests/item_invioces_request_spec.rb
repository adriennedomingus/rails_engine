...
RSpec.describe "Item invoice endpoint" do
  it "returns a hash of all item invoices" do
    ...
    item1 = m1.items.create(name: "item name", description: "item description", unit_price: 1000)
    item2 = m1.items.create(name: "item 2 name", description: "item 2 description", unit_price: 2000)
    item3 = m2.items.create(name: "item 3 name", description: "item 3 description", unit_price: 3000)
    ...
    ii1 = item2.invoice_items.create(invoice_id: invoice2.id, quantity: 2, unit_price: item2.unit_price)
    ii1 = item3.invoice_items.create(invoice_id: invoice1.id, quantity: 7, unit_price: item3.unit_price)
